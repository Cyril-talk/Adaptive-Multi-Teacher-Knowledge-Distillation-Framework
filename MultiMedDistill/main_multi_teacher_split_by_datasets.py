...
class MultiTeacherDistillationTrainer:
    ...
    def _forward_pass(self, images, targets, dataset_name, teacher_model, verbose=False):
        ...
        # 融合所有教师的特征
        if all_teacher_features and hasattr(self, 'cross_task_distiller'):
            if verbose:
...
def start_train():
    ...
    config = {
        ...
        'feature_weight': 0.01,  # 降低特征蒸馏权重
        'output_weight': 0.05,  # 降低输出蒸馏权重
        'task_weight': 0.94,  # 提高任务损失权重
